return {
	...
	config = function()
		...
		vim.api.nvim_set_hl(0, "BlinkCmpMenuBorder", { fg = "#ffffff" })
		vim.api.nvim_set_hl(0, "BlinkCmpMenuSelection", { fg = "#ffffff", bg = "#000000", bold = true })
		vim.api.nvim_set_hl(0, "BlinkCmpDocBorder", { fg = "#ffffff" })
		vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelpBorder", { fg = "#ffffff" })
