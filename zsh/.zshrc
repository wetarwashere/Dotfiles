...
alias delcache="sudo paccache -rk0 && paru -Scc && paru -Sccd && rm -rf $HOME/.local/share/zoxide && npm cache clean --force && rm -rf $HOME/.npm && rm -rf $HOME/.cache/paru && echo 'Cache successfully cleaned'"
